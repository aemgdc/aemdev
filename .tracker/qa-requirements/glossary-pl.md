# Translation glossary — Polish (pl)
...
Native name: **Polski**. Sheet tab and URL prefix: `pl` / `/pl`.
Connector code: `pl`.
...
Facts about Polish that tier 1 already enforces deterministically. They are written
...
| Text expansion vs English | 1.3x | `measureExpansion` divides the observed ratio by this before applying `qa.wordRatio`, so Polish running 1.3x longer is expected and not a finding |
...
**Empty because nothing has been translated into Polish yet.** Every row added here is
