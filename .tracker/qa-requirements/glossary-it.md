# Translation glossary — Italian (it)
...
Native name: **Italiano**. Sheet tab and URL prefix: `it` / `/it`.
Connector code: `it`.
...
Facts about Italian that tier 1 already enforces deterministically. They are written
...
| Text expansion vs English | 1.2x | `measureExpansion` divides the observed ratio by this before applying `qa.wordRatio`, so Italian running 1.2x longer is expected and not a finding |
...
**Empty because nothing has been translated into Italian yet.** Every row added here is
